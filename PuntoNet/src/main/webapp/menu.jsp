    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="container">
                ...
                <div>
                    <a class="navbar-brand nombreAcademia" href="principal.jsp"> ~ P U N T O N E T</a>
                </div>
                <br> <br>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="principal.jsp">HOME
                                <span class="sr-only">(current)</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="quienesSomos.jsp">NOSOTROS</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="productosHome.jsp">PRODUCTOS</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="terminosCondiciones.jsp">TERMINOS Y CONDICIONES</a>
                        </li>
