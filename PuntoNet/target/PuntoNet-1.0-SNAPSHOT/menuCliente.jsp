    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="container">
                ...
                <div>
                    <a class="navbar-brand nombreAcademia" href="homeCliente.jsp"> ~ P U N T O N E T</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="listadoProductos.jsp">LISTADO PRODUCTOS</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="carritoServlets">
                                <i class="fa-cart-plus">
                                    (<label style="color: greenyellow"> ${contador}</label>)
                                    CARRITO
                                </i>
                         ...
                         <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="MisPedidos">Pedidos</a>
                                    <a class="dropdown-item" href="modificarDatosUsuario">Mis Datos</a>
